...
namespace Lab4
{
    public partial class Form1 : Form
    {
        ...
        private void PerformOperation()
        {
            ...
            {
                if (operation.GetOperationSign() == SignComboBox.SelectedItem.ToString())
                {
        ...
        private void InfoVisibilityCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            if (InfoVisibilityCheckBox.Checked)
            {
